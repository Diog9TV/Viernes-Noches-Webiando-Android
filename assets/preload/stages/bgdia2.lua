function onCreate()
	...
	scaleObject('pub', 1.29,1.29);
	
	makeAnimatedLuaSprite('extra', 'week2/Publico_2', -1703, 450);
	setLuaSpriteScrollFactor('extra', 0.95, 0.97);
	scaleObject('extra', 1.29,1.29);
...
function onEvent(name,value1,value2)
	if name == 'Sion' then 
        ...
        doTweenX('Primeros', 'extra', 2500, 14, 'linear');
        objectPlayAnimation('extra', 'Moon', true)
        setProperty('extra.flipX',true)
