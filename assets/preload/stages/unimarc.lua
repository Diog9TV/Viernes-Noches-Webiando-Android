function onCreate()
	...
	makeAnimatedLuaSprite('gays', 'week1/MaavoIvette', -310, -18);
    ...
    addAnimationByPrefix('pico','Dick','Both_idles',24, true);
    addLuaSprite('cameo', false);
    addAnimationByPrefix('cameo','idle','sulayrebopper',24, true);
     addLuaSprite('taco', false);
    addAnimationByPrefix('taco','idle','mgrchilenita instance ',24, true);
    addLuaSprite('gays', false);
    addAnimationByPrefix('gays','idle','MAAVETTE',24, true);
    addLuaSprite('ger', false);
    addAnimationByPrefix('ger','idle','darkuro instance ',24, true);
    addLuaSprite('qliao', false);
    addLuaSprite('front', true);
    addAnimationByPrefix('front','mensos','BopCrowdFront',24, true);
    addLuaText('sion');
